...
vim.api.nvim_set_keymap("i", "<CR>", "compe#confirm({ 'keys': '<CR>', 'select': v:true })", { noremap = true, expr = true })
vim.api.nvim_set_keymap("i", "<C-Space>", "compe#confirm({ 'keys': '<CR>', 'select': v:true })", { noremap = true, expr = true })
vim.api.nvim_set_keymap("i", "<C-e>", "compe#close()", { noremap = true, expr = true })
